...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-image">
            <img src="https://via.placeholder.com/500x500/e2e8f0/64748b?text=AURA+Refrigerantes" alt="Lata AURA Refrigerante">
        </div>
    </section>
    ...
    <section class="flavors" id="sabores">
        ...
        <p class="section-subtitle">Formulado com botânicos e adaptógenos para cada momento.</p>
